...
public class StatisticJFrame extends JPanel{
    ...
    private void initComponents() {
        ...
        gbc.gridy = 1;  
        gbc.gridwidth = 1;
        lbDateNow = new JLabel("12/04/2022");
        ...
        gbc.gridy = 1;  
        gbc.gridwidth = 1;
        lbTurnover = new JLabel("300.000.000đ");
        ...
        gbc.gridx = 0;
        gbc.gridy = 4;  
        JPanel chartLayout = new JPanel(new BorderLayout());
        ...
        JFreeChart chart = ChartFactory.createBarChart("Biểu đồ", "monthly", "amount", dataset, PlotOrientation.VERTICAL, false,true,false);
