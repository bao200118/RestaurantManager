...
public class TableInfomationLayout extends JPanel{
    ...
    private void initComponents() {
       ...
       tbTable = new JTable(tables, properties);
       ...
       /**
        ...
        tableInfoFormLayout.setPreferredSize(new Dimension(tableInfoWidth, tableInfoHeight / 3));
        ...
        lbNumberCurrentTable.setText("10");
        ...
        businessLayout.setPreferredSize(new Dimension(tableInfoWidth, (int) (tableInfoWidth / 10)));
        ...
        tableLayout.setPreferredSize(new Dimension(tableInfoWidth, (int) (tableInfoHeight - tableInfoHeight/3 - tableInfoHeight / 10)));
